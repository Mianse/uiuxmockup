...
import { suggestions } from '@/data/costant'
...
function Hero() {
  ...
  const onCreateProject= async ()=>{
    ...
    <div className='p-10 md:px-24 lg:px-48 xl:px-60 mt-12'>
      ...
      <InputGroup className='max-w-xl  bg-white z-10  rounded-b-xl'>
        <InputGroupTextarea
  ...
  <SelectContent>
    ...
    <div className='flex gap-5 mt-10 '>
        {suggestions.map((suggestion,index)=>(
            <div key={index} className="p-2 border rounded-2xl flex flex-col items-center bg-white z-10 cursor-pointer" onClick={()=>setUserInput(suggestion?.description)}>
